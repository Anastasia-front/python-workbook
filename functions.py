...
within its own execution. It's like breaking a big problem down into smaller, more manageable problems.'''
...
so that when the function completes, the program can continue from the correct location.'''
