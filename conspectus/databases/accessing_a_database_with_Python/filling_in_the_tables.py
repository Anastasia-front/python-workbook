"""Now that we have two tables with projects and tasks, 
let's write helper functions to create projects and tasks:
"""
...
"""For create/modify/delete operations, we can read from the cursor the id of the row it last worked on in the lastrowid attribute.
"""


# Let's create a project and several tasks for it:
